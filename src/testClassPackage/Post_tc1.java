...
import req_Repo_Pkg.Post_req_repo;
	 	...
	 	for(int i=0; i<4; i++)
		{
		 ...
		 int statusCode=API_Common_Functions.res_statusCode(Post_req_repo.base_URI(),
           ...
           if(statusCode == 201)
           {
                ...
                Utility_CommonFunctions.evidencefilecreator("Post_tc1", Post_req_repo.Post_req_tc1(), res_body);
                break;
    ...
    public static void post_res_validator(String responsebody,int statusCode) throws IOException {
